...
<nav id="menu" class="bg-blue-100 text-gray-900 hidden shadow">
  <ul class="flex flex-col">
    ...
    <li><a href="{{ route('kelasdiajar') }}" class="block px-4 py-2 hover:bg-blue-200">Kelas Diajar</a></li>
    <li><a href="{{ route('input-kelas') }}" class="block px-4 py-2 hover:bg-blue-200">Input Kelas </a></li>
    <li><a href="{{ route('jadwal-mengawas-staff') }}" class="block px-4 py-2 hover:bg-blue-200">Jadwal Mengawas Staff</a></li>
    <li>
